$(function() {
	...
	function positionSuccess(position) {
		...
		L.tileLayer('http://{s}.tile.cloudmade.com/01aa77e396754ce68f494b0740c7118b/997/256/{z}/{x}/{y}.png', { maxZoom: 18, detectRetina: true }).addTo(map);
		
		// set map bounds
		// map.fitWorld();
		map.setView([lat, lng], 16);
		userMarker.addTo(map);
		userMarker.bindPopup('<p>You are there! Within ' + acr + ' meters</p>').openPopup();
